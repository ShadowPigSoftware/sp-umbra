...
SPUMBRA_DEPENDENCY_FILES=$(call spumbra_make_dependency_files,$(SPUMBRA_SOURCE_FILES),$(SPUMBRA_SOURCE_DIRECTORY)/%,$(SPUMBRA_BUILD_DIRECTORY)/source/%)
SPUMBRA_DEPENDENCY_FILES+=$(SPUMBRA_DEFAULT_MAIN_DEPENDENCY)
